...
public class JournalView implements LiteratureView {
    ...
    /**
     * The mode of the view. INFO if viewing details of Journal, EDIT if edit existing
     * Journal.
     */
    private Mode mode;
    ...
    public Pane buildUIView(Literature literature) {
        ...
        if (literature instanceof Journal) {
            ...
            TextField titleTF = new TextField(journal.getTitle());
            ...
            TextField publisherTF = new TextField(journal.getPublisher());
            ...
            TextField genreTF = new TextField(journal.getGenre());
            ...
            Spinner<Integer> yearlyPublicationsS = createNumericSpinner(journal.getPublicationsYearly());
            ...
            if (mode == Mode.EDIT) {
                ...
                update.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        journal.setTitle(titleTF.getText());
                        journal.setPublisher(publisherTF.getText());
                        journal.setGenre(genreTF.getText());
                        journal.setPublicationsYearly(yearlyPublicationsS.getValue());
