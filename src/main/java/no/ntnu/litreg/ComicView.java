...
public class ComicView implements LiteratureView {
    ...
    /**
     * The mode of the view. INFO if viewing details of Comic, EDIT if edit existing
     * Comic.
     */
    private Mode mode;
    ...
    public Pane buildUIView(Literature literature) {
        ...
        if (literature instanceof Comic) {
            ...
            TextField titleTF = new TextField(comic.getTitle());
            ...
            TextField publisherTF = new TextField(comic.getPublisher());
            ...
            TextField genreTF = new TextField(comic.getGenre());
            ...
            Spinner<Integer> yearlyPublicationsS = createNumericSpinner(comic.getPublicationsYearly());
            ...
            if (mode == Mode.EDIT) {
                ...
                update.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        comic.setTitle(titleTF.getText());
                        comic.setPublisher(publisherTF.getText());
                        comic.setGenre(genreTF.getText());
                        comic.setPublicationsYearly(yearlyPublicationsS.getValue());
