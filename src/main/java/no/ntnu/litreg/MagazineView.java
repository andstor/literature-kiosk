...
public class MagazineView extends Observable implements LiteratureView {
    ...
    /**
     * The mode of the view. INFO if viewing details of Magazine, EDIT if edit existing
     * Magazine.
     */
    private Mode mode;
    ...
    public Pane buildUIView(Literature literature) {
        ...
        if (literature instanceof Magazine) {
            ...
            TextField titleTF = new TextField(magazine.getTitle());
            ...
            TextField publisherTF = new TextField(magazine.getPublisher());
            ...
            TextField genreTF = new TextField(magazine.getGenre());
            ...
            Spinner<Integer> yearlyPublicationsS = createNumericSpinner(magazine.getPublicationsYearly());
            ...
            if (mode == Mode.EDIT) {
                ...
                update.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        magazine.setTitle(titleTF.getText());
                        magazine.setPublisher(publisherTF.getText());
                        magazine.setGenre(genreTF.getText());
                        magazine.setPublicationsYearly(yearlyPublicationsS.getValue());
